...
neutron subnet-create ext-net 192.168.$ID.0/24 --name ext-subnet --allocation-pool start=192.168.$ID.101,end=192.168.$ID.200 --disable-dhcp --gateway 192.168.$ID.2
